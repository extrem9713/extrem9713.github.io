...
`cartid` int(10) NOT NULL COMMENT '購物車id',
  `email` varchar(200) NOT NULL,
  `pname` varchar(40) NOT NULL COMMENT '商品名',
  `qty` smallint(2) NOT NULL COMMENT '數量',
...
(4, '森林野莓', 'Mix Berry Chocolate Cake', 1, 780, 1, '用浪漫紫色鋪上優雅外衣，一朵朵恰似花苞的裝飾帶點淡淡果香，選用法國果園野莓，天然的酸甜風味與巧克力蛋糕相互交疊，口感清爽不濕膩，內餡均勻分佈的野莓顆粒自然地呈現莓果及奶霜最單純的奢華滋味。', 'pr4-c', '北海道奶霜/巧克力泡芙蛋糕體/法國鮮奶油/綜合野莓', '6吋', '蛋奶素', '冷藏', '冷藏2天內食用完畢'),
...
(6, '甜心提拉', 'Super Tiramisu', 1, 720, 1, '道地來自於義大利馬斯卡邦起司。\r\n100%使用義大利馬斯卡邦起司，比面霜更加細膩的滑順質感搭配開啟味蕾的苦味可可粉，清爽的奶香、咖啡香、酒香不徐不疾地釋放出來，入口即化的香滑溼軟，令人心醉！', 'pr6-c', '北海道奶霜/法國鮮奶油/瑪斯卡邦起司慕斯/巧克力蛋糕/巧克力酥餅(此商品含酒)', '6吋', '葷食', '冷藏', '冷藏2天內食用完畢'),
...
(9, '粉紅露比', 'Ruby Chocolate Pie', 1, 810, 1, 'Ruby巧克力，天然新種巧克力，天然粉紅色澤，完全顛覆巧克力的想像，融合北海道奶霜，清拂一抹微酸、微甜的莓果質調。底部派塔厚實酥脆與泡芙蛋糕、覆盆莓奶霜、卡士達交疊著多層次迷人滋味。', 'pr9-c', '北海道奶霜/Ruby巧克力甘納許/泡芙蛋糕/覆盆莓卡士達/酥菠蘿/派塔', '6吋', '葷食', '冷藏', '冷藏2~3天內食用完畢'),
...
(12, ' 德國黑森林', 'Black Forest Cake', 1, 690, 1, '大人小孩都喜愛\r\n蛋糕膨鬆柔軟也很濕潤，有很濃的巧克力香氣。遇上夾層中的碎櫻桃鮮奶油餡後，整個口感更加輕盈，鼻間飄散著很輕很輕的櫻桃酒香。一點也不甜膩。', 'pr12-c', '巧克力泡芙蛋糕/酒釀碎櫻桃奶油/北海道奶霜/糖漬櫻桃', '8吋', '蛋奶素，含酒', '冷藏', '冷藏2天內食用完畢'),
...
--
ALTER TABLE `cart`
MODIFY `cartid` int(10) NOT NULL AUTO_INCREMENT COMMENT '購物車id';
--
